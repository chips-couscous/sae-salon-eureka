...
function ajouterValeurSelect(filieresUtilisateur, filiereUtilisateur) {
    ...
    let selectedIndex = filiereUtilisateur.selectedIndex;   
    let selectedOption = filiereUtilisateur.options[selectedIndex];
    let selectedText = selectedOption.innerText;
    console.log("Option sélectionnée : " + selectedText);
}
